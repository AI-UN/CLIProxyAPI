...
func TestNormalizeCodexServiceTier(t *testing.T) {
	tests := []struct {
		...
		{name: "ultrafast is canonical", rawJSON: `{"service_tier":"ultrafast"}`, want: "ultrafast", wantForw: true},
		{name: "ultrafast normalizes case and padding", rawJSON: `{"service_tier":" UltraFast "}`, want: "ultrafast", wantForw: true},
