...
// and the Responses payload both name it "priority". The ultrafast lane has no
// second spelling; it is listed so its canonical lowercase form survives a
// request that sends it cased or padded.
